    ...
    return(
        ...
        <AuthLayout>
            ...
            <form onSubmit={handleSubmit}>
                {/* New Password Input */}
                <div className="mb-4">
                <label className="block text-gray-700 font-medium">New Password <span className="text-red-500">*</span></label>
                ...
                {/* Submit Button */}
                <Button type="submit" disabled={loading}>{loading ? <ClipLoader color="#ffffff" size={19}/> : "Reset Password"}</Button>
                </form>
